...
export default function MentionsLegalesPage() {
  return (
    <article className="max-w-none text-gray-700 leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">Éditeur du site</h2>
      <ul>
      ...
      <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">Hébergement</h2>
      <ul>
      ...
      <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">Base de données</h2>
      <ul>
      ...
      <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">Propriété intellectuelle</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">Données patrimoniales</h2>
      <p>
